...
{
	auto size= CToolBar::CalcFixedLayout(bStretch, bHorz);
	return CSize(0x7fff, size.cy);
}

void CFlatToolBar::OnLButtonDown(UINT t, CPoint p)
{
	CWnd::OnLButtonDown(t, p);
//	CToolBar::OnLButtonDown(t, p);
}

void CFlatToolBar::OnLButtonDblClk(UINT flags, CPoint point)
{

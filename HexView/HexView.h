...
typedef struct _HEXCOL
{
	COLORREF colFG;
	COLORREF colBG;
	_HEXCOL() : colFG(0), colBG(0)
	{}
} HEXCOL, ATTR;
...
#define HVN_READ_DATA			(HVN_BASE + 8)  // requesting data to be disaplyed in hex view
...
struct NMHREADDATA : public NMHDR
{
	NMHREADDATA()
	{
		hwndFrom = 0;
	...
	size_w offset;		// read data from that offset
	size_w length;		// and this many bytes
	BYTE* dest_buf;		// into this buffer
};
